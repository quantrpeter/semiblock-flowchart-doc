...
| --- | --- | --- | --- |
| ![](img/oval.png){height=200} | Oval | Start / End | Shows where the process begins or ends |
| ![](img/rectangle.png){height=200} | Rectangle | Process | Shows an action or instruction |
| ![](img/diamond.png){height=200} | Diamond | Decision | Shows a question or condition |
| ![](img/in.png){height=200} ![](img/out.png){height=200} | Parallelogram | Input / Output | Shows information entering or leaving the system |
| ![](img/arow.png){height=200} | Arrow | Flow Line | Shows the direction of the process |
